...
const envSchema = z.object({
  ...
  ADMIN_CODE: z.string().min(4, 'ADMIN_CODE is required').default('ADMIN2026'),
  USER_RESET_CODE: z.string().min(4, 'USER_RESET_CODE is required').default('USERRESET2026'),
  ADMIN_RESET_CODE: z.string().min(4, 'ADMIN_RESET_CODE is required').default('ADMIN2026'),
